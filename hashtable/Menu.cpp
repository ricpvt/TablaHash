...
void MenuOperaciones(TablaHashDirA<C, V> &T, int tipo)
{
    int operacion = 0;

    do{
        cout << endl;
        if(tipo == 1){  cout << "Tabla Hash de tipo Entero-Cadena:" << endl;
        }else if(tipo == 2){    cout << "Tabla Hash de tipo Entero-Entero:" << endl;
        }else if(tipo == 3){    cout << "Tabla Hash de tipo Cadena-Cadena:" << endl;
        }else if(tipo == 4){    cout << "Tabla Hash de tipo Entero-Cadena:" << endl;
        }
        ...
        switch (operacion)
        {
            case AGREGAR:
            {
                ...
                while (true) {
                    ...
                    cout << "\n Error en entrada. Intenta de nuevo." << endl;
                    }
                    else break;
                }
